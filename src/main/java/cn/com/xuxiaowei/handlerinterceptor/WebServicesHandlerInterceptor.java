 ...
 * @author xuxiaowei
 */
public class WebServicesHandlerInterceptor extends AbstractPhaseInterceptor<SoapMessage> {
    ...
    public WebServicesHandlerInterceptor() {
    ...
    public void handleMessage(SoapMessage message) throws Fault {
        ...
        if (authorization == null) {
            ...
            if (StringUtils.isEmpty(plaintext) || !plaintext.contains(SEPARATE)) {
                throw new Fault(new SOAPException("Authorization 非 baisc 验证"));
            }
